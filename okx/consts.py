...
SET_TRANSFER_OUT = '/api/v5/users/subaccount/set-transfer-out'  # need to add
...
# Broker-all need to implemented-completed
...
SET_SUBACCOUNT_FEE_RATE = '/api/v5/broker/nd/set-subaccount-fee-rate'
...
ND_CREATE_APIKEY = '/api/v5/broker/nd/subaccount/apikey'
...
CANCEL_ALL_RFQS = '/api/v5/rfq/cancel-all-rfqs'
